...
_, dataset_info = tfds.load(name="cifar100", split='train[:1%]', batch_size=-1, data_dir=data_dir, with_info=True)
...
train_data = tfds.load(name="cifar100", split=trainsplit, batch_size=-1, data_dir=data_dir, with_info=False)
...
def get_rawdata_batches(batchsize=100, split='train[:100%]'):
  ...
  ds = tfds.load(name='cifar100', split=split, as_supervised=True, data_dir=data_dir)
