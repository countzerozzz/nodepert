...
# a list for running parallel jobs in slurm. Each job will correspond to a
# particular value in 'rows'. If running on a single machine,
# the config used will be the first value of 'rows' list. Here 'rows' will hold
# the values for different configs.
